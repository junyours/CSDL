...
import Create from "../../Guidance/Events/Create";
import Update from "../../Guidance/Events/Update";
...
export default function Index({ auth, events, filters }) {
    ...
    const handleOpenCreate = async () => {
        ...
        try {
            await toast.promise(
                axios.get("/event/create").then((res) => {
    ...
    const handleOpenUpdate = async (id) => {
        await toast.promise(
            axios.get(`/event/${id}/edit`).then((res) => {
    ...
    const handleManageClick = (id) => {
        router.get(`/manage-event/${id}/show`);
    };
