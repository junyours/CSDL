...
<body>
    ...
    <table width="100%" style="border: none; border-collapse: collapse;">
        <tr>
            ...
            <td style="text-align: right; vertical-align: top; border: none;">
                <img src="{{ public_path('assets/images/csdl-admin.png') }}" alt="Banner"
    ...
    <div class="date-section">
        <p><strong>Date:</strong> {{ $date_range['start'] }} - {{ $date_range['end'] }}</p>
    </div>
...
">
        ...
        <img src="{{ public_path('assets/images/bw-my-occ-banner.png') }}" alt="Banner" style="width:400px; height:auto;">
    </div>
</body>
